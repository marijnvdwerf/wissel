...
namespace openloco::ui::about_music
{
    ...
    static void draw_scroll(ui::window* window, gfx::drawpixelinfo_t* dpi, uint32_t scrollIndex)
    {
        ...
        for (auto song_strings : strings_to_draw)
        {
            ...
            // Song name
            draw_string_centred(*dpi, x, y, Palette::black, song_strings.first, nullptr);
            y += 10;

            // Credit line
            draw_string_centred(*dpi, x, y, Palette::black, song_strings.second, nullptr);
            y += 10;

            // Show CS' copyright after every two lines.
            draw_string_centred(*dpi, x, y, Palette::black, string_ids::music_copyright, nullptr);
            y += 14;
        }
    }
}
