...
namespace windowmgr = wissel::ui::WindowManager;
using input_flags = wissel::input::input_flags;
using input_state = wissel::input::input_state;
...
namespace wissel
{
    ...
    void main()
    {
        auto versionInfo = wissel::get_version_info();
...
__declspec(dllexport) int StartOpenLoco(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    wissel::glpCmdLine = lpCmdLine;
    wissel::ghInstance = hInstance;
    wissel::main();
    return 0;
}
#endif
