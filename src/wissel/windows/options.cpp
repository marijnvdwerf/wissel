...
#pragma mark - Widget 11
    ...
    namespace regional
    {
        ...
        static void prepare_draw(window* w)
        {
            ...
            if ((wissel::config::get().flags & config::flags::show_height_as_units) == 0)
            {
            ...
            if (wissel::config::get().measurement_format)
            {
    ...
    namespace misc
    {
        ...
        static void disable_vehicle_breakdowns_mouse_up(window* w)
        {
            auto& cfg = wissel::config::get_new();
