...
namespace wissel::ui::windows
{
    ...
    static void prepare_draw(ui::window* window)
    {
        ...
        if (wissel::get_screen_flags() & screen_flags::unknown_2)
        {
    ...
    static void draw(ui::window* window, gfx::drawpixelinfo_t* dpi)
    {
        ...
        if (window->widgets[widx::scenario_list_btn].type != ui::widget_type::none)
        {
            ...
            wissel::gfx::draw_image(dpi, x, y, image_id);
            wissel::gfx::draw_image(dpi, x, y, image_ids::title_menu_sparkle);
        }
        ...
        if (window->widgets[widx::load_game_btn].type != ui::widget_type::none)
        {
            ...
            wissel::gfx::draw_image(dpi, x, y, image_id);
            wissel::gfx::draw_image(dpi, x, y, image_ids::title_menu_save);
        }
        ...
        if (window->widgets[widx::tutorial_btn].type != ui::widget_type::none)
        {
            ...
            wissel::gfx::draw_image(dpi, x, y, image_ids::title_menu_lesson_l);
        }
...

        {
            ...
            if ((wissel::get_screen_flags() & screen_flags::unknown_2) != 0)
            {
                // char[512+1]
