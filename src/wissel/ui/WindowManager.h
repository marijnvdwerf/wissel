...
namespace wissel::ui::WindowManager
{
    void init();
    void registerHooks();
...
namespace wissel::ui::about
{
    void open();
}

namespace wissel::ui::about_music
{
    void open();
}

namespace wissel::ui::options
{
    window* open();
    window* open_music_settings();
}

namespace wissel::ui::prompt_browse
{
...
namespace wissel::ui::title_options
{
    window* open();
}

namespace wissel::ui::tooltip
{
    void register_hooks();
